...
import { Heart, Activity, Footprints, Flame, Bluetooth, Radio, Battery } from 'lucide-react-native';
  ...
  return (
    <ScrollView className="flex-1 bg-background">
      ...
      <View className="px-6 mt-6">
        ...
        <Pressable
          onPress={() => router.push("/(public)/scan" as any)}
          className={`rounded-3xl p-5 border shadow-sm flex-row items-center justify-between mb-6 active:opacity-90 ${
            isConnected
